...
def junta(l1, l2):
    ...
    maior_elemento_l1 = l1[-1]
    maior_elemento_l2 = l2[-1]

    if maior_elemento_l1 > maior_elemento_l2:
        return junta(l1[:-1], l2) + [maior_elemento_l1]
    else:
        return junta(l1, l2[:-1]) + [maior_elemento_l2]